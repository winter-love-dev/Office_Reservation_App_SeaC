...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  private void disconnect() {
    ...
    if (appRtcClient != null) {
      ...
      Toast.makeText(callActivity, "Call End", Toast.LENGTH_SHORT).show();

//       채팅방을 종료하고
//      Activity_ChatRoom activity_chatRoom = (Activity_ChatRoom) Activity_ChatRoom.activity_chatroom;
//      activity_chatRoom.finish();
//
//      // 다시 채팅방을 연다.
//      Intent intent = new Intent(CallActivity.this, Activity_ChatRoom.class);
//      intent.putExtra("call_finish", "call_finish");
