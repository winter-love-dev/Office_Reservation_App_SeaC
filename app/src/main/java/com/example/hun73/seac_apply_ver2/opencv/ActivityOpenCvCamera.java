package com.example.hun73.seac_apply_ver2.opencv;
...
////            Core.flip(matInput, matInput, Core.ROTATE_90_COUNTERCLOCKWISE);
////            Core.rotate(matInput, matInput, Core.ROTATE_90_CLOCKWISE); //ROTATE_180 or ROTATE_90_COUNTERCLOCKWISE
//
////            Mat mRgbaT = matInput.t();
////            Core.flip(matInput.t(), mRgbaT, Core.ROTATE_90_CLOCKWISE);
