...
public class Use_Work_Soon_Item implements Comparable<Use_Work_Soon_Item>
{
...
//    private String use_work_now_date_count; // 남은 날짜 (이건 클라에서 직접 구하는 것!!)
    ...
    public Use_Work_Soon_Item(String use_work_now_image,
                              String use_work_now_place_name,
                              String use_work_now_start_day,
                              String use_work_now_end_day,
                              String use_work_now_pay,
                              String use_work_now_total_use_day,
                              String use_work_now_place_number,
                              String aviliability,
                              String reserNo,
                              int count)
    {
    ...
    @Override
    public int compareTo(Use_Work_Soon_Item o)
    {
