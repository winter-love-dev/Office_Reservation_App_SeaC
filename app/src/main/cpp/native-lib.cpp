...
Java_com_example_hun73_seac_1apply_1ver2_ActivityOpenCvCamera_detect(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_example_hun73_seac_1apply_1ver2_ActivityOpenCvCamera_detect2(JNIEnv *env, jobject instance,
                                                                      jlong cascadeClassifier_face,
                                                                      jlong cascadeClassifier_eye,
                                                                      jlong matAddrInput,
                                                                      jlong matAddrResult) {
