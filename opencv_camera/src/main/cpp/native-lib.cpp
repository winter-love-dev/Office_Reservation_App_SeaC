...
Java_com_example_open_1cv_1test_ActivityOpenCvCamera_loadCascade(JNIEnv *env, jobject instance,
...
Java_com_example_open_1cv_1test_ActivityOpenCvCamera_detect(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_open_1cv_1test_ActivityOpenCvCamera_detect2(JNIEnv *env, jobject instance,
                                                             jlong cascadeClassifier_face,
                                                             jlong cascadeClassifier_eye,
                                                             jlong matAddrInput,
                                                             jlong matAddrResult) {
